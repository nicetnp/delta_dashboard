...
from services.failure_hipotone_service import fetch_failure_hipotone
...
@router.websocket("/ws/hipotone")
async def failure_hipotone_ws(websocket: WebSocket):
        ...
        while True:
            ...
            if cached_data:
                ...
                with SessionLocal() as db:
                    raw_data = fetch_failure_hipotone(failure_query_data, db)
                    serialized_data = [
