...
from services.failure_vflashone_service import fetch_failure_vflashone
        ...
        while True:
            ...
            if cached_data:
                ...
                with SessionLocal() as db:
                    raw_data = fetch_failure_vflashone(failure_query_data, db)
                    serialized_data = [
