...
from services.failure_vibration_service import fetch_failure_vibration
...
@router.websocket("/ws/vibration")
async def failure_vibration_ws(websocket: WebSocket):
        ...
        while True:
            ...
            if cached_data:
                ...
                with SessionLocal() as db:
                    raw_data = fetch_failure_vibration(failure_query_data, db)
                    serialized_data = [
