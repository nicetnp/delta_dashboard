...
const Card = memo(function Card({ 
  ...
  return (
    <div className={`${getVariantClasses()} rounded-2xl p-6 transition-all duration-300 hover:shadow-2xl hover:shadow-slate-900/40 hover:border-slate-500/50 ${className}`}>
      {(title || subtitle || icon) && (
        <div className="flex items-center space-x-4 mb-6">
          {icon && (
            <div className="w-14 h-14 bg-gradient-to-br from-slate-700 via-slate-600 to-slate-800 rounded-2xl flex items-center justify-center shadow-lg border border-slate-500/30">
