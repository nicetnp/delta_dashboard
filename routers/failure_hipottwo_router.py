...
from services.failure_hipottwo_service import fetch_failure_hipottwo
...
@router.websocket("/ws/hipottwo")
async def failure_hipottwo_ws(websocket: WebSocket):
        ...
        while True:
            ...
            if cached_data:
                ...
                with SessionLocal() as db:
                    raw_data = fetch_failure_hipottwo(failure_query_data, db)
                    serialized_data = [
